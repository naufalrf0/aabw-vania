                                ...
                                <tr>
                                    ...
                                    <td class="text-center" style="width:20%">
                                        ...
                                        <form action="<?= site_url('penyesuaian/' . $value->id_penyesuaian) ?>" method="post" id="del-<?= $value->id_penyesuaian ?>" class="d-inline">
                                            ...
                                            <button class="btn btn-danger btn-small" data-confirm="Hapus Data....? | Apakah anda Yakin....? - Karena Relasi Tabelnya Akan terhapus semua..." data-confirm-yes="hapus(<?= $value->id_penyesuaian ?>)"><i class="fas fa-trash-alt btn-small"> Del</i></button>
                                        </form>
                                    </td>
                                </tr>
