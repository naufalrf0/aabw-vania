                            ...
                            <?php foreach ($dtakun3 as $key => $value) : ?>
                                <tr>
                                    ...
                                    <td class="text-center" style="width:20%">
                                        ...
                                        <!-- <a href="" class="btn btn-danger"><i class="fas fa-trash-alt btn-small"></i>Del</a> -->
                                        <form action="<?= site_url('akun3/' . $value->id_akun3) ?>" method="post" id="del-<?= $value->id_akun3 ?>" class="d-inline">
                                            <?= csrf_field() ?>;
                                            <input type="hidden" name="_method" value="DELETE">
                                            <button class="btn btn-danger btn-small" data-confirm="Hapus Data....? | Apakah anda Yakin....?"
                                                data-confirm-yes="hapus(<?= $value->id_akun3 ?>)"><i class="fas fa-trash-alt btn-small">Del</i></button>
                                        </form>
                                    </td>
                                </tr>
