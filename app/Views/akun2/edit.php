            ...
            <div class="card-body p-4">
                ...
                <form method="post" action="<?= site_url('akun2/'. $dtakun2->id_akun2) ?>">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="kode_akun2" placeholder="Kode Akun" value="<?= $dtakun2->kode_akun2 ?>" 
                    </div>

                    <div class="form-group">
                        <label>Nama Akun 2</label>
                        <input type="text" class="form-control" name="nama_akun2" placeholder="Nama Akun" value="<?= $dtakun2->nama_akun2 ?>" 
                    <div class="form-group">
