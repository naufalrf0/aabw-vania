        ...
        <div class="main-wrapper">
            ...
            <nav class="navbar navbar-expand-lg main-navbar">
                ...
                <ul class="navbar-nav navbar-right">
                    ...
                    <li class="dropdown"><a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg nav-link-user">
                            <img alt="image" src="<?= base_url('imgFiles/' . user()->gambar) ?>" class="rounded-circle mr-1" style="width: 40px; height: 40px;  border-radius: 50%; object-fit: cover; overflow: hidden;">
            ...
            <footer class="main-footer">
                <div class="footer-left">
                    Copyright &copy; 2024 <div class="bullet"></div> Design By <a href="https://nauval.in/">Vania Putri Salsabila</a>
                </div>
