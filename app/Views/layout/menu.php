...
<li class="#"><a class="nav-link" href="<?= site_url('neracasaldo') ?>"><i class="fas fa-balance-scale-right"></i><span>Neraca Saldo</span></a></li>
<li class="#"><a class="nav-link" href="<?= site_url('neracalajur') ?>"><i class="fas fa-tasks"></i></i></i><span>Neraca Lajur</span></a></li>
...
<?php if(in_groups('admin')) : ?>
    <li class="#"><a class="nav-link" href="<?= site_url('admin') ?>"><i class="fas fa-users"></i></i></i><span>Users</span></a></li>
<?php endif; ?>